...
- [0005 Safe installer scripts](0005-safe-installer-scripts.md): Provide installer scripts that append ignores, back up replaced files, and write numbered candidates for same-name Markdown/map files.
