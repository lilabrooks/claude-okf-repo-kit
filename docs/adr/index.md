...
- [0021 Kit-managed second-agent mirror sync](0021-second-agent-mirror-sync.md): Teach the updater to refresh declared second-agent hook mirrors in place (byte-identical, provenance-guarded), removing the manual re-sync step; skills stay owner-managed. Proposed.
