...
- [0024 Second-agent port as an installed skill](0024-second-agent-port-skill.md): Ship the recurring second-agent port procedure as the sixth installed skill, with warn-only undeclared-mirror advisories in verify-install and the SessionStart hook. (proposed)
