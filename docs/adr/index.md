...
- [0026 Rewrite kit-side installer tools in Python stdlib](0026-python-installer-rewrite.md): Move the never-installed kit-side tools to Python stdlib behind the smoke suite; hooks and scripts/okf stay standalone bash. Proposed, implementation trigger-gated.
